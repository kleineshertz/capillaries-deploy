...
module(load="imfile")
input(type="imfile" File="/var/log/casandra/system.log" Tag="cassandra_system" Severity="info" ruleset="udp_bastion")
input(type="imfile" File="/var/log/casandra/debug.log" Tag="cassandra_debug" Severity="info" ruleset="udp_bastion")
